          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <ul class="edit-menu">
              	...
              	<li class="active"><i class="icon ion-ios-briefcase-outline"></i><a href="edit-profile-work-edu">Education and Work</a></li>
                ...
                <li><i class="icon ion-ios-settings"></i><a href="edit-profile-settings">Account Settings</a></li>
              	<li><i class="icon ion-ios-locked-outline"></i><a href="edit-profile-password">Change Password</a></li>
              </ul>
            </div>
            <div class="col-md-7">

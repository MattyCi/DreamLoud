      ...
      <nav class="navbar navbar-static-top menu">
        <div class="container">
          ...
          <div class="img-responsive-logo">
            <a href="index-register"><img src="resources/images/dl_logo_2_trans_nav.png" alt="logo"/></a>
          </div>
        </div><!-- /.container -->
      </nav>
    </header>
    ...
    <div id="lp-register">
        ...
        <div class="row">
            ...
            <div class="intro-texts">
              <h1 class="text-white"> DREAMLOUD</h1>
            	<h2 class="text-white">Unleash Your Dreams, Reach Your Goals, Mobilize Technology!</h2>
           ...
           <div class="reg-form-container">
             ...
             <div class="tab-content">
                <div class="tab-pane active" id="register">
                  ...
                  <p class="text-muted">Become a Dreamer Today!</p>
